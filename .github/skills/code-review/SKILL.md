...
6. Record the reviewed head SHA in the final-review attestation. Automated comments do not count as GitHub approval and do not natively block merging.
7. For Dependabot changes limited to dependency manifests and lockfiles, rely on substantive CI, vulnerability checks and lockfile integrity; workflow, source, generated-code and mixed changes still require final-material review.
